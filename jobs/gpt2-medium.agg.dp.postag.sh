...
mkdir -p rationalization_results/analogies/gpt2-medium.agg.dp.postag
mkdir -p logs/analogies/gpt2-medium.agg.dp.postag
python src/rationalization/random_replacing/run_analogies.py \
    --rationalization-config config/gpt2-medium.agg.dp.postag.json \
    --model gpt2-medium \
    --tokenizer gpt2-medium \
    --data-dir data/analogies \
    --output-dir rationalization_results/analogies/gpt2-medium.agg.dp.postag \
    --device cuda \
    --logfile logs/analogies/gpt2-medium.agg.dp.postag/0.log \
    --input_data_size 1 \
...
#     --data-dir data/analogies \
#     --target-dir rationalization_results/analogies/gpt2-medium.agg.dp.postag \
#     --baseline-dir rationalization_results/analogies/gpt2-medium.last_attention \
#     --output-path evaluation_results/analogies/gpt2-medium.agg.dp.postag.csv \
#     --tokenizer gpt2-medium 
